...
struct SessionDetailView: View {
        ...
        let task = URLSession.shared.dataTask(with: request) { (data, response, error) in
            ...
            do{
                ...
                if (smObject.error == true) {
                    ...
                    self.confirmationMessage = "Joined session successfully."
                }
    ...
    //
               ...
               //ADD BUTTON HERE
                ...
                Button(action: {self.joinSession()})
                       {
...
struct SessionDetailView_Previews: PreviewProvider {
    static var previews: some View {
        SessionDetailView(id: 0, courseCode: "code", firstName: "first", lastName: "last", date: "date", startTime: "startTime", endTime: "endTime", address: "address", room: "room", sessionDescription: "description", latitude: "00.0000000", longitude: "00.000000", title: "title", isPrivate: "true")
    }
}
