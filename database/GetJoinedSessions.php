...
//retrieve session from database
    $stmt = $conn->prepare("SELECT DISTINCT s.sessionID, s.title, s.courseCode, s.sessionDescription, s.date, s.startTime, s.endTime, s.address, s.room, s.isPrivate, s.latitude, s.longitude, u.firstName, u.lastName FROM sessions as s, userSessions as us, users as u WHERE us.userID = ? AND s.sessionID = us.sessionID AND s.ownerID = u.userID ORDER BY s.date ASC, s.startTime ASC");
